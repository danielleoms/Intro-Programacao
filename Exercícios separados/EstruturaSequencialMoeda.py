...
#O programa deve solicitar ao usuário o valor da cotação do dólar e a quantidade de dólares disponível, para que seja apresentado o valor em moeda brasileira.
